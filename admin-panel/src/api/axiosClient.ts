...
/** Bare client for the refresh call so it never triggers the interceptor loop. */
...
const NO_REFRESH_PATHS = [ENDPOINTS.auth.superAdminLogin, ENDPOINTS.auth.refresh];
