    ...
    <div className="pointer-events-none fixed bottom-4 right-4 z-[100] flex w-full max-w-sm flex-col gap-3">
      {toasts.map((toast) => {
        ...
        return (
          <div
            key={toast.id}
            className="animate-in pointer-events-auto relative flex items-start gap-3 overflow-hidden rounded-xl border border-subtle bg-surface p-4 shadow-popover"
          >
